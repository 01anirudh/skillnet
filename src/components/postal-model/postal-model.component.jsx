...
import { Container,	Content,Header,	SharedContent,UserInfo,ShareCreation,AttachAsset,AssetButton,ShareComment,PostButton,Editor,UploadImage,} from "./postal-model.styles";
					...
					<Content>
						...
						<SharedContent>
							<UserInfo>
								...
								<span>{props.user && props.user.displayName ? props.user.displayName : "Name"}</span>
							</UserInfo>
							<Editor>
